...
public class PreferenceStoreTests {
    ...
    public void serializePreferenceStore() {
        String json = "{"
                ...
                + "        ],"
                + "   \"scripting.starred-expressions\":{\"class\":\"com.google.refine.utility.preference.TopList\",\"top\":2147483647,\"list\":[]},"
                + "   \"scripting.expressions\":{\"class\":\"com.google.refine.utility.preference.TopList\",\"top\":100,\"list\":[]}"
                + "}}";
